function varargout=shadedErrorBar(x,y,errBar,lineProps,transparent,lineColor) 
...
if exist('lineColor','var')
    H.mainLine=plot(x,y,cell2mat(lineProps),'Color',lineColor,'LineWidth',1);
else
    H.mainLine=plot(x,y,cell2mat(lineProps),'LineWidth',1);    
end
...
patchSaturation=0.28; %How de-saturated or transparent to make patch
if transparent
...
% H.edge(1)=plot(x,lE,'-','color',edgeColor,'LineWidth',1);
% H.edge(2)=plot(x,uE,'-','color',edgeColor,'LineWidth',1);
