function [F0, F0_L, F0_U, F_seq, peak_info] = Frequency_extraction_curv(Curv, fps, delta)
%FREQUENCY_EXTRACTION
% % Compute frequency using peakfinding after avg in 1 direction
AA = cosineSimilarity(Curv);
C = AA;
N = size(C, 1);
...
% peak_info.pksmax = pksmax0;
% peak_info.wmax = wmax0;
% peak_info.pmax = pmax0;
% peak_info.pksmin = pksmin0;
% peak_info.wmin = wmin0;
% peak_info.pmin = pmin0;
% peak_info.imax = imax0;
% peak_info.imin = imin0;
% peak_info.ipks = ipk;
